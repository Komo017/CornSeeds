...
################################################################################
## Form generated from reading UI file 'IndustrialCamerajJBiHr.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.showYoloPage = QWidget()
        self.showYoloPage.setObjectName(u"showYoloPage")
        self.layoutWidget = QWidget(self.showYoloPage)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(0, 0, 691, 501))
        self.horizontalLayout = QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2 = QVBoxLayout()
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.resultshow1 = QLabel(self.layoutWidget)
        self.resultshow1.setObjectName(u"resultshow1")

        self.verticalLayout_2.addWidget(self.resultshow1)

        self.resultshow3 = QLabel(self.layoutWidget)
        self.resultshow3.setObjectName(u"resultshow3")

        self.verticalLayout_2.addWidget(self.resultshow3)
        ...
        self.resultshow2 = QLabel(self.layoutWidget)
        self.resultshow2.setObjectName(u"resultshow2")

        self.verticalLayout_3.addWidget(self.resultshow2)

        self.resultshow4 = QLabel(self.layoutWidget)
        self.resultshow4.setObjectName(u"resultshow4")

        self.verticalLayout_3.addWidget(self.resultshow4)


        self.horizontalLayout.addLayout(self.verticalLayout_3)

        self.stackedWidget.addWidget(self.showYoloPage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.resultshow1.setText("")
        self.resultshow3.setText("")
        self.resultshow2.setText("")
        self.resultshow4.setText("")
    # retranslateUi
